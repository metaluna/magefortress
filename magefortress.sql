...
CREATE TABLE tiles (id INTEGER PRIMARY KEY, map_id INTEGER NOT NULL, room_id INTEGER NOT NULL, object_id INTEGER NOT NULL, x INTEGER NOT NULL, y INTEGER NOT NULL, z INTEGER NOT NULL, underground INTEGER NOT NULL, dug_out INTEGER NOT NULL, wall_n INTEGER NOT NULL, wall_e INTEGER NOT NULL, wall_s INTEGER NOT NULL, wall_w INTEGER NOT NULL, floor INTEGER NOT NULL);